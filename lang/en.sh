...
MENU_OPTION_2="View recorded devices"
...
# 设备操作相关的消息
WAITING_NEW_DEVICE="Waiting for a new USB device to be inserted..."
...
ENTER_PERMISSION="Please enter the device permission (e.g., 0777):"
INVALID_PERMISSION="Invalid permission. Please enter a valid permission (e.g., 0777)."
...
ENTER_NEW_PERMISSION="Enter the new permission (e.g., 0777):"
